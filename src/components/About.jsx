               ...
               <div className='about-info-right'>
                    <div className={`card ${theme ?'' : 'card-bg' }`}>
                        ...
                        <div className={`card-body ${theme ? '' : 'card-body-bg' }`} >
                            ...
                            <br/>
                            <br/>
                            👋 I'm Abhishek Panwar. Fictional person for preview purposes :) I'm working with newest front-end frameworks like React and Next.js. What you are seeing now is portfolio template from github @abhishekpanwarrr. If you like this portfolio template, make sure to ⭐ the repository to make it more recognizable for other users. Thank you 💜
                            </p>   
                        </div>
                    </div>
               </div>
