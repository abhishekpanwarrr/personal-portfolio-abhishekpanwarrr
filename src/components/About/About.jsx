          ...
          <div className={`polariod ${theme ? "" : "polariod-bg"}`}>
            ...
            <div>
              <svg
                ...
                viewBox="0 0 256 228"
                style={{ fontSize: "32px", margin: "9% 5% 0px" }}
              >
                <path
          ...
          <div className={`card ${theme ? "" : "card-bg"}`}>
            ...
            <div className={`card-body ${theme ? "" : "card-body-bg"}`}>
              ...
              <p>
                ...
                <br />
                <br />
                👋 I'm Abhishek Panwar. Fictional person for preview purposes :)
                I'm working with newest front-end frameworks like React and
                Next.js. What you are seeing now is portfolio template from
                github @abhishekpanwarrr. If you like this portfolio template,
                make sure to ⭐ the repository to make it more recognizable for
